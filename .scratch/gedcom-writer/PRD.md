# PRD: gedcom — a GEDCOM 7.0.18 writer for Python
...
- Authoritative references in-repo: `docs/spec/gedcom-writer-map.md` (the implementer-facing spec map), `CONTEXT.md` (glossary), and `docs/adr/0001–0003` (the locked decisions). These should be kept in sync as implementation proceeds.
